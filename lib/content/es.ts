  ...
  lessons: [
    {
      ...
      mediaNote:
        "Filmar una lección de escucha de la montaña con visuales de campo, pausas y sonido ambiental.",
      description:
    ...
    },
    {
      ...
      mediaStatus: "NEEDS_REAL_VIDEO",
      mediaNote:
        "Filmar una lección sobre reciprocidad mostrando prácticas cotidianas entre comunidad, territorio y gratitud.",
      description:
    ...
    },
    {
      ...
      mediaStatus: "NEEDS_REAL_VIDEO",
      mediaNote:
        "Filmar una lección de atención ritual centrada en gestos repetidos y respetuosos sin enfoque de espectáculo.",
      description:
    ...
    },
    {
      ...
      mediaStatus: "NEEDS_REAL_VIDEO",
      mediaNote:
        "Filmar una lección de cierre sobre custodia y transmisión responsable con contexto, atribución y humildad.",
      description:
